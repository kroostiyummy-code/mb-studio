...
const settings = defineCollection({
  ...
  schema: z.object({
    ...
    histoire: z.object({
      ...
      kicker: z.string().optional(),      // ex: "L'Héritage" — petit label au-dessus du statement
      image: z.string().optional(),       // URL/path d'une image associée (grande à côté du texte)
      image_alt: z.string().optional(),
      quote: z.string().optional(),       // citation encadrée
    }).optional(),
